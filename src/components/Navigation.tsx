    ...
    <nav class="flex justify-between items-center p-4 bg-gray-900">
      ...
      <div
        class={`absolute inset-0 ${
          isOpen() ? "flex" : "hidden"
        } flex-col gap-6 pt-8 text-center bg-gray-900 sm:static sm:flex sm:flex-row sm:pt-0`}
      >
        <a
        ...
        <a
          class={`text-xs uppercase font-semibold ${
            pathname === "/about" || pathname === "/about/" ? "underline" : ""
          } underline-offset-2`}
          href="/about"
        >
          Want to know me
      ...
      <div class="flex gap-6">
        <a href="https://github.com/estradax" target="_blank">
          <svg
            class="w-6 h-6"
            viewBox="0 0 100 100"
            fill="currentColor"
        ...
        <a href="https://twitter.com/dassysutcliffe" target="_blank">
          <svg
            class="w-6 h-6"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
